 ...
 *
 * Pin assignments (Intro-to-CAD-2026 v0.1 board, YD-RP2040 module):
 *   GPIO10  FMT  -- PCM1808 FMT (LOW = I2S standard format)
 *   GPIO11  MD1  -- PCM1808 MD1 (LOW=512fs/48kHz, HIGH=256fs/96kHz)
 *   GPIO12  SDA  -- Si5351a I2C data
 *   GPIO13  SCL  -- Si5351a I2C clock
 *   GPIO14  DATA -- PCM1808 DOUT (PIO in_base)
 *   GPIO15  BCK  -- PCM1808 BCK  (PIO in_base + 1)
 *   GPIO16  WS   -- PCM1808 LRCK (PIO in_base + 2)
...
#define DATA_PIN      14   /* PCM1808 DOUT  -> PIO in_base              */
#define FMT_PIN       10   /* PCM1808 FMT   -> LOW = I2S standard fmt   */
#define MD1_PIN       11   /* PCM1808 MD1   -> LOW = Master 512fs       */
...
static void handle_line(const char *line, uint8_t len)
{
    ...
    /* RATE,<hz> -- store pending sample rate; applied at next stream start */
...
int main(void)
{
    ...
    /* DATA (GPIO14), BCK (GPIO15), WS (GPIO16) are all inputs from PCM1808 */
