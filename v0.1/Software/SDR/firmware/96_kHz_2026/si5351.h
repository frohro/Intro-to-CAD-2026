...
// Reference crystal on the 2026 board.
// 24.576 MHz = 512 × 48000 Hz -- deliberately chosen so that integer (N, M)
// pairs exist at useful 40-meter SDR frequencies.
...
#define SI5351_REG_CLK0_PHOFF   165  // CLK0 phase offset (units: Tvco/4); set to 0 for I
#define SI5351_REG_CLK1_PHOFF   166  // CLK1 phase offset; set to M for 90 deg Q offset
