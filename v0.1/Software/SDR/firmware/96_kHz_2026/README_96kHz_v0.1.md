# WWU SDR — 48/96 kHz Dual-Rate UAC1 Research Firmware

**Tested hardware:** Intro-to-CAD-2026 v0.1 board (YD-RP2040 module)

> **Note — v0.2 board incoming:** A v0.2 PCB is in progress that will
> support either **DIRECT mode** (CLK0→I, CLK1→Q, current wiring) or
> **Johnson counter mode**.  This firmware targets the v0.1 board only;
> set `BOARD_DIRECT_MODE true` in `main.c`.  When the v0.2 board arrives,
> change that define to `false` for Johnson counter operation and update
> the Si5351a phase-offset logic accordingly.
...
| 12 | SDA | I2C | Si5351a I2C data (100 kHz; required for MS5351M clone on v0.1) |
