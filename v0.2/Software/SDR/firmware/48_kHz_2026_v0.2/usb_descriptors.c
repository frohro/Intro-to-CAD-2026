...
#define AUDIO_BLOCK_LEN  ( \
    ...
    TUD_AUDIO10_DESC_STD_AS_LEN             +  /* AS alt 1 (Active)             */ \
...
static const uint8_t desc_configuration[] = {
    ...
    /* Standard AS Interface — alt 1: Active (1 isochronous EP) */
    TUD_AUDIO10_DESC_STD_AS_INT(/*_itfnum*/ ITF_NUM_AUDIO_STREAMING,
                                 /*_altset*/ 0x01,
                                 /*_nEPs*/   0x01,
                                 /*_stridx*/ 0x00),
...
#if CFG_TUD_AUDIO_FUNC_1_SAMPLE_RATE == 96000
    0x00, 0x77, 0x01,      /* tSamFreq[0] = 96 000 Hz  */
#else
    0x80, 0xBB, 0x00,      /* tSamFreq[0] = 48 000 Hz  */
#endif

    /* Standard AS ISO EP: fits both rates
     * 294 bytes for 48 kHz, 582 bytes for 96 kHz. */
