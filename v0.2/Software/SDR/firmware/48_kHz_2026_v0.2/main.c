...
static void apply_sample_rate(uint32_t rate)
{
    ...
    /* PCM1808 mode: MD1=HIGH → 256fs (96 kHz), MD1=LOW → 512fs (48 kHz) */
    gpio_put(MD1_PIN, (rate == 96000U) ? 1 : 0);
                           ...
                           tusb_control_request_t const *p_request)
{
     ...
     * to consult g_pending_rate.  snd-usb-audio selects alt 1 for 48 kHz
     * and alt 2 for 96 kHz based on the descriptor it enumerated. */
...
int main(void)
{
    ...
    /* PCM1808 MD1=LOW + MD0 tied HIGH on board -> Master 512fs mode.
     * BCK = 64 x 48000 = 3.072 MHz, LRCK = 48 kHz, SCKI = 24.576 MHz. */
    gpio_init(MD1_PIN);
