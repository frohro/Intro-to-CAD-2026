 ...
 *   Alt 1: wMaxPacketSize = 582, 96 kHz only  (fits EHCI Single-TT)
 *   AUDIO_BLOCK_LEN: 112
 *
 ...
 * │      (no EPs)                                                      │
 * │  Interface 3 alt 1 — Audio Streaming 96 kHz                       │
...
static const uint8_t desc_configuration[] = {
    ...
    /* Standard AS Interface — alt 1: Active 96 kHz (1 isochronous EP) */
    TUD_AUDIO10_DESC_STD_AS_INT(/*_itfnum*/ ITF_NUM_AUDIO_STREAMING,
                                 /*_altset*/ 0x01,
                                 /*_nEPs*/   0x01,
                                 /*_stridx*/ 0x00),
    ...
    /* Standard AS ISO EP: 96 kHz
     * 582 bytes for 96 kHz (96+1 frames * 3 bytes * 2 ch = 582) */
