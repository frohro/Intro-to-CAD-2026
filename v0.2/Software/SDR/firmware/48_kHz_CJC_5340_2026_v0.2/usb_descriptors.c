...
static const uint8_t desc_configuration[] = {
    ...
    /* Standard AS Interface — alt 1: Active 48 kHz (1 isochronous EP) */
    TUD_AUDIO10_DESC_STD_AS_INT(/*_itfnum*/ ITF_NUM_AUDIO_STREAMING,
                                 /*_altset*/ 0x01,
                                 /*_nEPs*/   0x01,
                                 /*_stridx*/ 0x00),
    ...
    /* Standard AS ISO EP: 48 kHz
     * 294 bytes for 48 kHz (48+1 frames * 3 bytes * 2 ch = 294) */
