#!/usr/bin/env bash
#
# Build script for Unified Intro-to-CAD-2026 v0.2 SDR Firmware
...
echo "============================================================"
echo " Building Unified SDR Firmware (v0.2 Board)"
...
echo "============================================================"
echo " Build Complete!"
echo " Output UF2: ${BUILD_DIR}/sdr_v0.2_unified.uf2"
echo "============================================================"
