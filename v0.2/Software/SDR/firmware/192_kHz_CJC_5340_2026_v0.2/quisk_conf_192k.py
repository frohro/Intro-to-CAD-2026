...
# Research version: fixed 192 kHz (S16_LE over USB)
#
# Firmware captures 24-bit samples and streams dithered 16-bit audio at 192 kHz.
# Keep Quisk and firmware sample rates matched.
...
# At 192 kHz Quisk's DSP load is significantly higher. A larger output
# buffer helps absorb transient CPU spikes and avoid underruns.
lin_latency_millisecs = 700
...
class Hardware(BaseHardware):
    ...
    def _log_comparison_pair(self):
        ...
        if self._comparison_pair["integer_count"] > 1:
            ...
            print("WORST same as BEST: only one valid integer LO in the overlapping IF windows")
        else:
